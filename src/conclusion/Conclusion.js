  ...
  render() {
    return (
      <>
        ...
        <p>
          We also learned how, when there is a performance issue or long running request in one part of the system, it can have a catastrophic effect on the other parts of the system that are generally fast and run with no performance issues.
        </p>
        <p>
